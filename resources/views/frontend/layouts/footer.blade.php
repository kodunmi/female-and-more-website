<div class="join-us-section all-text-white lazy" data-src="images/join-us-bg.jpg">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="join-us">
...
<footer class="fund-footer lazy" data-src="images/footer/footer-bg.jpg">
                ...
                <div class="col-md-12">
                    <div class="main-footer__top text-center pdb10">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                            Duis aute irure dolor in reprehenderit in velit esse cillum dolore eu fugiat nulla pariatur. </p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="widget__text-content">
                            <ul>
                                <a href="{{ route('register') }}">
                                    <li>- Register for female and more.</li>
                                </a>
                                <a href="{{ route('how-to-participate') }}">
                                    <li>- Check out all participants.</li>
                                </a>
                                <a href="{{ route('learders-board') }}">
                                    <li>- Check the leaders board.</li>
                                </a>
                                <a href="{{ route('causes') }}">
                                    <li>- View all our causes</li>
                                </a>
                            </ul>
                        </div>
                    </div>
