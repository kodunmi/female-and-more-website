    ...
    <div class="container-fluid no-padding">
        ...
        <div class="story-header">
            ...
            <div class="story-title">
                <p>business Enterpreneur</p>
            </div>
            <div class="icon-title">
                <h3>taya fela one durotayo</h3>
            </div>
        </div>
        <div class="story-body">
            ...
            <div class="question-btn">
                <button class="btn">Go To Question</button>
            </div>
...
var a = $(this).attr('id');
$(".tab-wrapper").find("div").removeClass('show');
var current = $(".tab-wrapper").find("."+a).addClass('show');
